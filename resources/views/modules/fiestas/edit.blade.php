            ...
            <form action="/productos" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    <div class="col-sm-3">
                        ...
                        <input name="descripcion" class="form-control" type="date" required>
                    </div>
                    ...
                    <div class="col-sm-3">
                        ...
                        <input name="horaFinal" class="form-control" type="time" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-sm-3">
                        ...
                        <input name="horaComida" class="form-control" type="time" required>
                    </div>
                    ...
                    <div class="col-sm-3">
                        ...
                        <input name="piñata" class="form-control" type="text" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input name="edad" class="form-control" type="number">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input name="numeroCasa" class="form-control" type="text">
                    </div>    
                </div>
                <div class="form-group row">
                    <div class="col-sm-6">
                        <label for="my-input">Número celular</label>
                        <input name="numeroTel" class="form-control" type="text">
                    </div>
