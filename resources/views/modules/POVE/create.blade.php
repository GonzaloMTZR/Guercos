@extends('layouts.template') @section('title', '- Punto de venta entrada') @section('content')
  ...
  <div class="row align-items-end">
    <div class="col-lg-8">
      <div class="page-header-title">
        ...
        <div class="d-inline">
          <h4>Punto de venta del area de entrada</h4>
  ...
  <div class="row">
    <div class="col-sm-">
      ...
      <div class="card">
        ...
        <!-- nuevo diseño del punto de venta  -->
            ...
            <div class="row">
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="form-group">
                  <input type="search" class="form-control form-control-round" placeholder="Busqueda por nombre o código del producto">
                </div>
              </div>
            </div>
            <div class="row">
              ...
              <div class="col-xl-2 col-md-2 col-sm-2 col-xs-12">
                <div class="card prod-view">
                  <div class="prod-item text-center">
                    <div class="prod-img">
                      <a href="#!" class="hvr-shrink">
                                    <img src="/imagenes/productos/{{$producto->imagenProducto}}"  class="img-fluid o-hidden" alt="prod1.jpg">
                                </a>
                    </div>
                    <div class="prod-info">
                      ...
                      <div class="m-b-10">
                        ...
                        <label class="label label-{{$producto->stock <= 10 ? 'danger' : 'success'}}"> {{$producto->stock}}</label>
                      </div>
                      <span class="prod-price"><i class="icofont icofont-cur-dollar"></i>@convert($producto->precio)</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="card-block">
          <form action="/PDVE" method="POST">
            ...
            <div class="row">
              ...
              <div class="table-responsive">
                <table id="detalles" class="table table-striped table-bordered table-condensed table-hover">
                  ...
                  <tfoot>
                    ...
                    <th></th>
                    <th>
                      <h4 id="total">S/. 0.00</h4> <input type="text" name="total_venta" id="total_venta"></th>
                  </tfoot>
                  <tbody>
                  </tbody>
                </table>
              ...
              <!-- div de los botones de guardar -->
            </div>
            <!-- Aqui acaba el row del form-->
          </form>
        </div>
        <!-- Aqui acaba el card block-->
      </div>
    </div>
  </div>
</div>
  ...
  function agregar() {
    ...
    if (id_articulo != "" && cantidad != "" && cantidad > 0 && precio_venta != "" && descuento != "") {
      ...
      if (stock >= cantidad) {
        ...
        var fila = '<tr class="selected" id="fila' + cont + '"><td><button class"btn btn-danger" type"button" onclick="eliminar(' + cont + ');">X</button></td><td><input type="hidden" name="id_articulo[]" value="' + id_articulo + '">' + articulo + '</td><td><input type="number" name="stock[]" value="' + cantidad + '"></td><td><input type="number" name="precio_venta[]" value="' + precio_venta + '" readonly></td><td><input type="number" name="descuento[]" value="' + descuento + '"></td><td>' + subtotal[cont] + '</td></tr>';
